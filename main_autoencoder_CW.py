...
for r_xp in range(rep):
    ...
    emb_entr = random.randrange(32,trace_size_original,32)    
    ...
    if r_xp == 0:
        ...
        plt.savefig(image_root + 'Orig_traces_' + dataset + "_" + leakage+ ".png")
    ...
    if r_xp == 0:
        ...
        for k in range(256):
            label_k = aes_label_cpa(dataloadertrain.plt_profiling[:used_traces], k, leakage)
        ...
        label_correct_key = aes_label_cpa(dataloadertrain.plt_profiling[:used_traces], dataloadertrain.correct_key, leakage)
        ...
        plt.savefig(image_root + 'Actual_corr_' + dataset + "_" + leakage+ "_CW.png")
    ...
    label_correct_key = aes_label_cpa(dataloadertrain.plt_profiling, dataloadertrain.correct_key, leakage)
    ...
    if len(nan_check)==len(cpa_k):
        ...
        if max_metric > best_corr:
            ...
            plt.savefig(image_root + 'Corr_' + dataset + "_" + leakage+ ".png")
            ...
            plt.savefig(image_root + 'Gen_traces_' + dataset + "_" + leakage+ ".png")
